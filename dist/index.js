...
var useApi = (options = {}) => {
  ...
  const [params, setParams] = (0, import_react.useState)(settings.initialParams);
  ...
  const apiRequest = (0, import_react.useRef)(settings.apiManager);
  ...
  const updateParams = (0, import_react.useCallback)((updates) => {
